...
def _enum_stem_match(
    ...
    enum_hypothesis_list = list(
        filter(lambda x: x[0] in enum_unmat_hypo_list[0], enum_hypothesis_list)
    )

    enum_reference_list = list(
        filter(lambda x: x[0] in enum_unmat_ref_list[0], enum_reference_list)
    )
...
def _enum_allign_words(
    ...
    '''
    print("hyp -  ",enum_hypothesis_list)
    print("ref -  ",enum_reference_list)
